...
class Cemetry {
    ...
    private int [][] placesss = new int [3][3];
    ...
    private void Placesss(){
        System.out.println("Выберите место для уборки могилы:");
        for (int i = 0; i < placesss.length; i++) {
            for (int j = 0; j < placesss[i].length; j++) {
                System.out.print(placesss[i][j] + " ");
            }
            System.out.println();
        }
    }
    ...
    private void vskritie() {
        ...
        System.out.println(answer + " успешно вскрыт.");
    }
    ...
    private void krem() {
        ...
        System.out.println(answer + " успешно кремирован.");
    }
    ...
    private void fire() {
        ...
        System.out.println(answer + " успешно сожжен.");
    }
    ...
    public static void exitCemetery() {
